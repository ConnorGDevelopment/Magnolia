  ...
  <v-row id="services">
    <v-col cols="12">
      <v-card :class="classBundle.backgroundCard">
        <v-card-title :class="classBundle.display1"> Services </v-card-title>
        ...
        <v-card-subtitle :class="classBundle.body1">
          ...
          <br />
          All prices are starting points and may be more or less depending on
          complexity, length and density of the hair.
          <br />
          You are welcome to schedule a fifteen minute complimentary
          consultation before you schedule.
          <br />
